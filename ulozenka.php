...
public function copyLogo($id_carrier, $typ=1) {
     switch($typ) {
         case 1: $sourceImg='ulozenka.jpg'; break;
         case 2: $sourceImg='ulozenkask.jpg'; break;
         case 3: {
 ...
 */
Mail::Send((int)$params['objOrder']->id_lang, $this->name, $topic, $data, $Customer->email, $Customer->firstname.' '.$Customer->lastname,
