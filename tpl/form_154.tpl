{*
for prestashop 1.5.2 (not tested) and 1.5.4 
@copyright  prestahost.cz
*}
            ...
            <fieldset id="fieldset_{$f}">
                {foreach $fieldset.form as $key => $field}
                    {if $key == 'legend'}
                        ...
                        <br /><br />
                        <br /><br /><a href="http://www.ulozenka.cz/kontakty" target="_blank"><img src="../modules/ulozenka/ulozenka.jpg"></a> 
                        {l s='Support' mod='ulozenka'} <a href='mailto:podpora@ulozenka.cz'>podpora@ulozenka.cz</a>

                        <br /> 
                        <br />

                    {elseif $key == 'custom_content'}
                        {$custom_content}
